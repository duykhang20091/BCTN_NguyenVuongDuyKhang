...
<div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                        ...
                        <tbody>
                            @foreach($loaitin as $chitiet)
                                <tr class="odd gradeX" align="center">
                                    ...
                                    <td class="center"><a href="admin/loaitin/sua/{{ $chitiet->id }}"><i class="fa fa-pencil fa-fw"></i></a></td>
                                    <td class="center">
                                       
                                        <input type="hidden" class="hiddenID" value="{{ $chitiet->id }}">

                                        <a href="#" class="btnDel" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#myModal{{$chitiet->id}}"> <i class="fa fa-trash-o fa-fw"></i></a>
                    ...
                    <form action="{{url('admin/loaitin/import-csv')}}" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">

                        <input type="file" name="file" accept=".xlsx"><br>
                       <input type="submit" value="Import CSV" name="import_csv" class="btn btn-warning">
                        </form>
                       <form action="{{url('admin/loaitin/export-csv')}}" method="POST">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
